...
import toString, {replacer} from '../src/toString';
...
test('if toString uses JSON.stringify with replacer correctly, and falls back to prune when needed', (t) => {
...
test('if toString can handle crazy circular objects', (t) => {
  try {
    toString(window);
